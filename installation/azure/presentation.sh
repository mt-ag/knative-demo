...
p "\e[36mglooctl \e[39minstall knative --install-knative-version 0.9.0 --install-monitoring"
gloo.exe install knative --install-knative-version 0.9.0 --install-monitoring
